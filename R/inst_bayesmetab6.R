...
data.dir <- here('BASEmetab-res/input6')
results.dir <- here('BASEmetab-res/output6')
...
# 0.3545239 is average ecometab KL for Dec 2017, from inst_ecometab4
K.meas.mean <- 0.3545239 / 1.5
K.meas.sd <- 1e-9
